...
// 				if (value.pinyin == old){
// 					flag = 1;
// 					// $('#keypad').val(old + value.value);
// 					html += '<li><input id="add" class="in" type="button" onclick="ik(this.value);"  value="'+value.value+'"></li>'
...
// 			if(flag == 1){
// 				$('.suggetions').show('slow');
// 				$('.suggetions').html(html);
// 			}
// 			else{
// 				$('.suggetions').hide('slow');
// 			}
